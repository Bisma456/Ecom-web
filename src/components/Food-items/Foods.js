	...
	return (
		<BtnStyle className="container">
			<div className={ `btn-type text-center active-${showItems.property.id}`}>
				<button onClick={handleClick} className="btn mx-3 cakes">
					Cakes
				</button>
				<button onClick={handleClick} className="btn mx-3 ice creams">
					Ice Creams
				</button>
				<button onClick={handleClick} className="btn mx-3 other Sweets">
				   Other Sweets
				</button>
			</div>
